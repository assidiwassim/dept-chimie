              ...
              <div class="box box-animation" style="padding:0 !important;">
               <div class="box-header boxImg" style="background-image:url('/upload/PictureAnnonce/{{$annonce->file}}');">
                ...
                @if( $annonce->user_id!=Auth::user()->id)
                        ...
                        @if($annonce->typeannonce=="Offre")
                            <a href="/labo/annonces/offre/{{$annonce->id}}" class="btn btn-default btn-lg btn-block btn-repondre" >Demander</a>
                        @else
                            <a href="/labo/annonces/demande/{{$annonce->id}}" class="btn btn-default btn-lg btn-block btn-repondre-Demande  " >Répondre</a>
                        @endif
